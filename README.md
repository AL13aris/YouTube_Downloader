...
### English Version
This project is for **educational, research, and personal backup purposes only**. 

1. **No Affiliation:** This project is an independent open-source tool and is not affiliated with, authorized, maintained, or endorsed by YouTube, Google LLC, or any of its affiliates.
2. **Terms of Service & Copyright:** Downloading copyrighted content without authorization may violate the YouTube Terms of Service and local copyright laws. The author does not condone, encourage, or promote any form of copyright infringement or misuse of this tool.
3. **User Responsibility:** The user assumes all legal responsibilities and risks arising from the use, execution, or modification of this source code. 
4. **No Warranty:** As per the GNU General Public License v3 (GPL v3), this software is provided "as is" without warranty of any kind, either expressed or implied. The author shall not be liable for any damages or account restrictions resulting from the use of this software.

---

### 한국어 버전
본 프로젝트는 **오직 교육, 연구 및 개인 백업 목적**으로만 제작되었습니다.

1. **관계성 없음:** 본 프로젝트는 독립적인 오픈소스 도구이며 유튜브(YouTube), 구글(Google LLC) 또는 그 계열사와 어떠한 연관도 없으며, 그들로부터 승인이나 지원을 받지 않았습니다.
